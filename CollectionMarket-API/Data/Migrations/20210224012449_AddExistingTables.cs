        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AttributeValues_ProductTypes_ProductTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SaleOffers_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SaleOffers_ProductTypes_ProductTypeId",
                        column: x => x.ProductTypeId,
                        principalTable: "ProductTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SaleOffers_AspNetUsers_SellerId",
                        column: x => x.SellerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttributeValues_ProductTypeId",
                table: "AttributeValues",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleOffers_OrderId",
                table: "SaleOffers",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_SaleOffers_ProductTypeId",
                table: "SaleOffers",
                column: "ProductTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_SaleOffers_SellerId",
                table: "SaleOffers",
                column: "SellerId");
        }
